...
import 'package:coconut_disease_detection/features/tracking/viewmodels/tracking_viewmodel.dart';
...
class Tracking extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final controller = Get.put(TrackingViewModel());
...
class TrackingFormContainer extends StatelessWidget {
  final String title;
  final TextEditingController commentController;
  final Function(double) onRatingUpdate;

  const TrackingFormContainer({
    Key? key,
    required this.title,
...
class ElevatedButtonWidget extends StatelessWidget {
  final TrackingViewModel controller;
